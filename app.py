...
# Page config
st.set_page_config(page_title="MarkC Assistant 02", page_icon="🤖")
...
with st.sidebar:
    st.title("🤖 MarkC Assistant 02")
    st.markdown("""
    This is an AI assistant powered by Datastax Langflow.
